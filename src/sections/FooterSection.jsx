  ...
  if (type === 'discord') {
    return (
      <svg
        ...
        strokeLinejoin="round"
      >
        <path d="M9 10.5c.5-.6 1.2-1 2-1s1.5.4 2 1" />
        <path d="M15 18c-1.2.8-2.6 1.2-4 1.2S8.2 18.8 7 18" />
        <path d="M8.5 16c-1.8.2-3.3.8-4.5 1.8 0 0 .6-4.6 2.6-7.8C8 7.2 10 6.5 12 6.5s4 .7 5.4 3.5C19.4 13 20 17.6 20 17.6c-1.2-1-2.7-1.6-4.5-1.8" />
        <path d="M9.5 12.8h0" />
        <path d="M14.5 12.8h0" />
      </svg>
    )
